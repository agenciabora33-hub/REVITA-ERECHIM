...
export const WHATSAPP_NUMBER = "5554999175763";
export const WHATSAPP_MESSAGE = "Olá! Vi seu contato no Google e preciso de uma avaliação.";
export const WHATSAPP_LINK = `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(WHATSAPP_MESSAGE)}`;

// SVG Icons as components or constants for cleaner usage
// Fixed: Using React.createElement since this is a .ts file and cannot contain JSX
export const Icons = {
    WhatsApp: () => (
        React.createElement("svg", { className: "w-6 h-6 fill-current", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg" },
    ...
    Check: () => (
        React.createElement("svg", { className: "w-6 h-6 text-green-600", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg" },
            React.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M5 13l4 4L19 7" })
        )
    ),
    Bolt: () => (
        React.createElement("svg", { className: "w-8 h-8 text-green-600", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg" },
